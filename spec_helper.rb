...
=end
  ...
  # rack_test driver for Capybara support
  config.before(:each, type: :system) do
    driven_by :rack_test
  end
  # make driven_by available system wide
  config.before(:each, type: :system, js: true) do
    driven_by :selenium_chrome_headless
  end
end

# Get some helpful messaging for failed policy tests
# as well as correctly send the right objects to the policy
